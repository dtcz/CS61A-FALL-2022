...
def tail_points(opponent_score):
    ...
    diff = tens - ones if tens > ones else ones - tens
    return 2 * diff + 1
    # END PROBLEM 2
...
def is_always_roll(strategy, goal=GOAL):
    ...
    while score0 <= goal:
        score1 = 0
        while (score1) <= goal:
            if nums != strategy(score0, score1):
                return False
            score1 = score1 + 1
        score0 = score0 + 1
    return True
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    if square_update(1, score, opponent_score, make_test_dice(tail_points(opponent_score))) - score >= threshold:
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if tail_points(opponent_score) >= 5:
        return 0
